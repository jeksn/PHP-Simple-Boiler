    ...
    <div class="flex flex-wrap items-center sm:-mx-3">
      <div class="w-full md:w-1/2 md:px-3">
        <div class="w-full pb-6 space-y-6 sm:max-w-md lg:max-w-lg md:space-y-4 lg:space-y-8 xl:space-y-9 sm:pr-5 lg:pr-0 md:pb-0">
          <h1 class="font-extrabold tracking-tight text-gray-900 dark:text-white">
          ...
          <p class="mx-auto text-base text-gray-500 dark:text-white sm:max-w-md lg:text-xl md:max-w-3xl">
            Small boilerplate for simple PHP websites.
          </p>
          <div class="relative flex flex-col sm:flex-row sm:space-x-4">
            <a href="/about" class="flex items-center w-full px-6 py-3 mb-3 text-lg text-black bg-teal-500 rounded-md dark:text-white sm:mb-0 hover:bg-teal-700 sm:w-auto" data-primary="indigo-600" data-rounded="rounded-md">
              Try It Free
            ...
            <a href="/" class="flex items-center px-6 py-3 text-gray-500 bg-gray-100 rounded-md hover:bg-gray-200 hover:text-gray-600" data-rounded="rounded-md">
              Learn More
            </a>
          </div>
        </div>
